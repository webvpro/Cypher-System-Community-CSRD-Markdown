...
> **Effect:** A successfully attacked target within short range whose level is equal to or less than the artifact's disappears; the target's essence is trapped in the artifact. If a previously trapped creature was already in the artifact, it appears where the newly trapped one was located.

...
Inkubuses slice targets with knife‑sharp paper cuts as their attack.
...
The inkubus is more self‑aware than most other forgeborn, and may interact with characters by using its Words on the Floor ability.

### Use

The PCs receive a letter from a famous alchemist, which becomes an inkubus that relays the alchemist's message (an invitation, a warning, a threat, or something else).

### GM Intrusion

Important documents or other papers the character carries flap away and become part of the inkubus.
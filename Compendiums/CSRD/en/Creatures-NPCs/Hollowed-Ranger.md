...
A hollowed ranger's long‑range entropic bullet—fired from a rifle‑shaped hole in reality—deals 4 points of Intellect damage (ignores Armor) as a bit of the target's reality is blasted away.
...
Speaking with a voice like wind on gravestones, a hollowed ranger may tell of the primary target of their vengeance, deliver a message from a more powerful necrovore, or simply promise to eat the soul of whoever tries negotiating with them.

### Use

Characters need to travel a huge distance and are told the quickest way is to use the door shift offered by a hollowed ranger, though doing so will require appeasing the ranger in some way.

### GM Intrusion

The character drawn through the hollowed ranger's form to a deathly realm is attacked by a ghost lurking there.
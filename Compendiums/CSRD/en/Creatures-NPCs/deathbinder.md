...
A deathbinder attacks twice each round with long‑range pistol attacks.
...
Deathbinders don't cotton to interruptions because the reason they chose undeath in the first place was to pursue a specialized purpose—usually, even deeper secrets of alchemy and/or collecting more unique magical artifacts and treasures.

### Use

A herd of ghost cattle wanders into town and causes problems. Folks say it's the fault of the "lich cowboy" who lives out in the wastes.

### Loot

The deathbinder's pistols have uniquely powerful rounds loaded in them; roll once on the Alchemical Rounds and Slugs table.

### GM Intrusion

The deathbinder makes an extra pistol attack even if it's not their turn.